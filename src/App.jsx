...
export default function App() {
  ...
  // P1 - P5 = STUDIO APARTMENT
  const studioProjects = [
    {
      id: 1,
      title: "Studio Apartment - View 01",
      img: "/p1.jpg",
    },
    {
      id: 2,
      title: "Studio Apartment - View 02",
      img: "/p2.jpg",
    },
    {
      id: 3,
      title: "Studio Apartment - View 03",
      img: "/p3.jpg",
    },
    {
      id: 4,
      title: "Studio Apartment - View 04",
      img: "/p4.jpg",
    },
    {
      id: 5,
      title: "Studio Apartment - View 05",
      img: "/p5.jpg",
    },
  ];

  // P6 - P10 = LIVING ROOM & KITCHEN
  const livingProjects = [
    {
      id: 6,
      title: "Living Room & Kitchen - View 01",
      img: "/p6.jpg",
    },
    {
      id: 7,
      title: "Living Room & Kitchen - View 02",
      img: "/p7.jpg",
    },
    {
      id: 8,
      title: "Living Room & Kitchen - View 03",
      img: "/p8.jpg",
    },
    {
      id: 9,
      title: "Living Room & Kitchen - View 04",
      img: "/p9.jpg",
    },
    {
      id: 10,
      title: "Living Room & Kitchen - View 05",
      img: "/p10.jpg",
    },
  ];
  ...
  return (
    <div className="min-h-screen overflow-x-hidden bg-[#020d1d] text-slate-100 font-sans selection:bg-cyan-400 selection:text-slate-950">
              ...
              {navItems.map(([name, link], i) => {
                return (
                  <a
                    ...
                    className={
                      i === 0
                        ? "text-[10px] uppercase tracking-widest transition text-cyan-400 border-b border-cyan-400 pb-1"
                        : "text-[10px] uppercase tracking-widest transition text-slate-300 hover:text-cyan-400"
                    }
                  >
                    {name}
                  </a>
      ...
      <section
        id="home"
        className="relative min-h-[85svh] lg:min-h-screen flex items-center pt-24 pb-10 px-5 overflow-hidden"
      >
        ...
        <div className="absolute inset-0 lg:hidden">
          ...
          <div className="absolute inset-0 bg-[#020d1d]/70" />

          <div className="absolute inset-0 bg-gradient-to-b from-[#020d1d]/90 via-[#020d1d]/55 to-[#020d1d]/95" />

          <div className="absolute inset-0 bg-cyan-400/5" />
        </div>

        {/* HERO BACKGROUND GLOW */}
        <div className="absolute -top-40 -left-40 w-[500px] h-[500px] bg-cyan-500/10 rounded-full blur-[130px] pointer-events-none" />

        <div className="absolute top-[40%] -right-40 w-[500px] h-[500px] bg-teal-500/10 rounded-full blur-[130px] pointer-events-none" />
        ...
        <div className="relative z-10 max-w-6xl mx-auto w-full grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative z-10 text-center lg:text-left">
            ...
            {/* BADGE */}
            <div className="inline-flex px-4 py-2 rounded-full border border-cyan-400/50 bg-[#020d1d]/70 backdrop-blur-md text-cyan-400 text-[9px] uppercase tracking-widest mb-7">
              ✦ Available For Interior Design Projects
            </div>

            {/* GREETING */}
            <p className="text-slate-200 text-lg mb-3 drop-shadow-lg">
              Hi there 👋, I am
            </p>

            {/* NAME */}
            <h1 className="font-serif text-5xl sm:text-6xl lg:text-7xl font-bold leading-tight text-white drop-shadow-[0_4px_15px_rgba(0,0,0,0.7)]">
              <TypewriterEffect
                texts={[
                  "Nimra Sarfraz",
            ...
            {/* PROFESSION */}
            <h2 className="text-2xl sm:text-3xl font-serif font-bold text-cyan-400 mt-4 drop-shadow-lg">
              Interior Designer
            </h2>

            {/* DESCRIPTION */}
            <p className="text-slate-200 lg:text-slate-400 max-w-xl mt-6 leading-7 text-sm sm:text-base mx-auto lg:mx-0 drop-shadow-lg">
            ...
            <div className="flex flex-wrap justify-center lg:justify-start gap-4 mt-8">
              ...
              <a
                href="#contact"
                className="px-7 py-3.5 rounded-full bg-cyan-400 text-slate-950 text-xs font-bold uppercase tracking-wider hover:bg-cyan-300 transition flex items-center gap-2 shadow-[0_0_25px_rgba(34,211,238,0.3)]"
              >
                Hire Me
                <FaArrowRight />
              </a>
              ...
              <button
                ...
                className="px-7 py-3.5 rounded-full border border-cyan-400/80 bg-[#020d1d]/60 backdrop-blur-md text-cyan-400 text-xs font-bold uppercase tracking-wider hover:bg-cyan-400 hover:text-slate-950 transition flex items-center gap-2"
              >
                <FaEye />
                View CV
              </button>
      ...
      >
        ...
        <div className="flex flex-wrap justify-center gap-3 mb-10">
          ...
          <button
            ...
            className={
              activeTab === "studio"
                ? "px-6 py-3 rounded-full text-[10px] font-bold uppercase tracking-widest border transition bg-cyan-400 text-slate-950 border-cyan-400"
                : "px-6 py-3 rounded-full text-[10px] font-bold uppercase tracking-widest border transition border-cyan-400/50 text-cyan-400 hover:bg-cyan-400 hover:text-slate-950"
            }
          >
            Studio Apartment
          </button>
        ...
        {/* GALLERY */}
        <div className="grid grid-cols-2 lg:grid-cols-3 gap-1.5 sm:gap-4">

          {currentProjects.map((project) => (
            <div
              key={project.id}
              onClick={() => setSelectedImage(project)}
              className="group cursor-pointer overflow-hidden rounded-xl sm:rounded-2xl border border-cyan-400/20 bg-[#031326] hover:border-cyan-400/60 transition"
            >

              <div className="h-44 sm:h-56 lg:h-64 overflow-hidden relative">
                ...
                <div className="absolute bottom-2 left-2 right-2 sm:bottom-4 sm:left-4 sm:right-4 flex justify-between items-end">
                  ...
                  <div>
                    ...
                    <p className="text-[7px] sm:text-[9px] text-cyan-400 uppercase tracking-widest">
                      Click to Preview
                    </p>

                    <h3 className="text-[10px] sm:text-sm font-semibold mt-1 leading-tight">
                      {project.title}
                    </h3>

                  </div>

                  <FaEye className="text-cyan-400 text-xs sm:text-base" />
      ...
      {cvOpen && (
        ...
        >
          ...
          <div
            ...
            className="relative w-full max-w-5xl h-[96vh] bg-[#031326] border border-cyan-400/40 rounded-2xl sm:rounded-3xl p-3 sm:p-5 overflow-hidden shadow-[0_0_50px_rgba(34,211,238,0.15)]"
          >

            {/* HEADER */}
            <div className="flex items-center justify-between border-b border-slate-800 pb-3 mb-3">

              <h3 className="text-cyan-400 font-serif font-bold text-sm sm:text-base">
                NIMRA SARFRAZ — CV
              </h3>

              <button
                onClick={() => setCvOpen(false)}
                className="w-9 h-9 rounded-full bg-slate-800 flex items-center justify-center text-white hover:bg-cyan-400 hover:text-slate-950 transition"
              >
                <FaTimes />
              </button>
            ...
            {/* =================================================
                CV IMAGE
            ================================================= */}
            <div className="h-[calc(96vh-120px)] overflow-auto bg-black/40 rounded-xl flex justify-center items-start p-2 sm:p-4">

              <img
                src="/p21.jpg"
                alt="Nimra Sarfraz CV"
                className="w-auto h-auto max-w-none sm:max-w-full rounded-lg object-contain select-none"
                style={{
                  imageRendering: "auto",
                }}
                draggable="false"
            ...
            <div className="flex justify-end mt-3">
              ...
              <button
                onClick={() => setCvOpen(false)}
                className="px-7 py-2.5 rounded-full border border-slate-700 text-slate-300 text-xs uppercase tracking-widest hover:border-cyan-400 hover:text-cyan-400 transition"
              >
                Close
              </button>
